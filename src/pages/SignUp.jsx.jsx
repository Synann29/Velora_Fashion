...
export default function SignUp() {
  ...
  <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
    ...
    <div className="flex flex-col justify-center bg-white px-6 py-10 sm:px-10 lg:px-16">
      <span className="text-xs sm:text-sm font-medium text-[#8B5E3C] uppercase tracking-wider">
        Welcome
      </span>

      <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mt-2 text-gray-900">
        Create Account
      </h1>
